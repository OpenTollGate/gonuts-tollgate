...
// NUT #17: This NUT defines a websocket protocol that enables bidirectional communication between apps and mints using the JSON-RPC format.
type WsRequest struct {
	JsonRPC string        `json:"jsonrpc"`
	Method  string        `json:"method"`
	Params  RequestParams `json:"params"`
	// NUT #17: Note that `id` and `subId` are unrelated.
	Id int `json:"id"`
}

type RequestParams struct {
	Kind string `json:"kind"`
	// NUT #17: `subId` is a unique UUID v7 generated by the wallet and allows the client to map its requests to the mint's responses.
...
type SupportedMethod struct {
	...
	// NUT #17: Here, `commands` is an array of the commands that the mint supports.
